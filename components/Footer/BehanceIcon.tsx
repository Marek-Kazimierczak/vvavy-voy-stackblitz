...
/**
 * Lightweight inline SVG Behance icon component.
 * - Uses `currentColor` so you can style via `color` / CSS classes.
 * - Defaults to 32px size, customizable via `size` prop.
 */
const BehanceIcon: React.FC<Props> = ({
  size = 32,
  className = '',
  title = 'Behance',
}) => (
